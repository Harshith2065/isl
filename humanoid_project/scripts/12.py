"""Task 1.2 _ Version2b: Extract 25-keypoint human poses from an input image using Mediapipe,
display in OpenCV window, and SAVE annotated output to ../results/"""
...
if __name__ == "__main__":
    ...
    # Convert annotated image to BGR for OpenCV
    ...
    save_path = os.path.join("../results", "pose_annotated.jpg")
    cv2.imwrite(save_path, annotated_bgr)
    print(f"\n✅ Annotated image saved to: {save_path}")

    # Display the annotated image in a separate OpenCV window
    cv2.imshow("Annotated Pose", annotated_bgr)
